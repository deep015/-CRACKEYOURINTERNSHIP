...
var maxScore = function(cardPoints, k) {
    ...
    // If k equals the length of cardPoints, return totalSum
    ...
    let currentSubarraySum = minSubarraySum;

    // Use sliding window to find the minimum sum of subarray of length windowSize
    ...
    return totalSum - minSubarraySum; // Maximum score
};